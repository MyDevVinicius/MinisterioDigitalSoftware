  ...
  return (
    <div className="flex w-full">
      ...
      <div className="flex-1 bg-gray-100 p-6">
        ...
        {isEditing && (
          <div className="text-balck mt-4 border p-4 font-bold">
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                placeholder="Nome"
                required
                className="text-balck my-2 w-full border border-media p-2 font-bold"
              />
              <input
                type="email"
                value={email}
        ...
        <div className="mt-4">
          <table className="min-w-full table-auto">
            <thead>
              <tr>
                <th className="text-bold border border-media px-4 py-2 text-media">
                  Nome
                </th>
                <th className="text-bold border border-media px-4 py-2 text-media">
                  Email
            ...
            <tbody>
              {usuarios.map((usuario) => (
                <tr key={usuario.id}>
                  <td className="border border-media px-4 py-2 font-bold text-black">
                    {usuario.nome}
                  </td>
                  <td className="border border-media px-4 py-2 text-center font-bold text-black">
                    {usuario.email}
                  </td>
                  <td className="border border-media px-4 py-2 text-center font-bold text-black">
                    {usuario.cargo}
